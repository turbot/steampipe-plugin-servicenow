...
func tableServicenowSnChgRestChangeTask() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "escalation", Description: "Escalation.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "escalation").NullIfEqual("")},
			...
			{Name: "impact", Description: "Impact.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "impact").NullIfEqual("")},
			...
			{Name: "priority", Description: "Priority.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "priority").NullIfEqual("")},
			{Name: "reassignment_count", Description: "Reassignment Count.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "reassignment_count").NullIfEqual("")},
			...
			{Name: "state", Description: "State.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "state").NullIfEqual("")},
			...
			{Name: "sys_mod_count", Description: "Sys Mod Count.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "sys_mod_count").NullIfEqual("")},
			...
			{Name: "urgency", Description: "Urgency.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "urgency").NullIfEqual("")},
