...
func tableServicenowSnChgRestChange() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "Integer", Description: "Change Integer assigned to the change request by the system, such as CHG0040007.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "Integer").NullIfEqual("")},
			...
			{Name: "reassignment_count", Description: "Integer of times that the change request has been reassigned to a new owner.", Type: proto.ColumnType_INT, Transform: transform.FromP(getFieldValue, "reassignment_count").NullIfEqual("")},
			...
			{Name: "task_effective_Integer", Description: "Universal request Integer.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldValue, "task_effective_Integer").NullIfEqual("")},
