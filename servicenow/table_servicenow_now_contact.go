...
func tableServicenowNowContact() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "sys_created_on", Description: "Data and time the associated contact was originally created.", Type: proto.ColumnType_STRING},
			...
			{Name: "sys_updated_on", Description: "Data and time the associated contact information was updated.", Type: proto.ColumnType_STRING},
