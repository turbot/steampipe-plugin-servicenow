...
func tableServicenowNowConsumer() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "sys_created_on", Description: "Date and time the consumer record was originally created.", Type: proto.ColumnType_STRING},
			...
			{Name: "sys_updated_on", Description: "Date and time when the consumer information was last updated.", Type: proto.ColumnType_STRING},
