...
func tableServicenowCmdbCiService() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			{Name: "aliases", Description: "Other names for this service - comma-delimited list of names.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldFromSObjectMap, "aliases")},
			...
			{Name: "delivery_manager", Description: "The delivery manager for this service.", Type: proto.ColumnType_JSON, Transform: transform.FromP(getFieldFromSObjectMap, "delivery_manager")},
			...
			{Name: "mac_address", Description: "MAC Address.", Type: proto.ColumnType_STRING, Transform: transform.FromP(getFieldFromSObjectMap, "mac_address")},
